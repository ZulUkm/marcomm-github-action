...
Route::get('/login', [App\Http\Controllers\Auth\ApiLoginController::class, 'showLoginForm'])->name('login');
Route::post('/login', [App\Http\Controllers\Auth\ApiLoginController::class, 'login']);
Route::post('/logout', [App\Http\Controllers\Auth\ApiLoginController::class, 'logout'])->name('logout');

// Add these login routes OUTSIDE the auth middleware group
...
Route::get('/calendarsss', function () {
    return view('calendar');
})->name('calendar');
