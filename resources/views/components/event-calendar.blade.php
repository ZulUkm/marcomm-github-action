...
<link rel="stylesheet" href="{{ URL::asset('build/libs/fullcalendar/main.min.css') }}">
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            ...
                            <div class="bg-dark rounded text-center position-relative p-4">
                                ...
                                <h6 class="text-white position-relative z-1 mb-3">Enjoy Unlimited Access on a small price
                                    monthly.</h6>
                                <a href="#" class="btn btn-white d-inline-flex position-relative z-1">Upgrade Now <i
                                        class="ti ti-arrow-right"></i></a>
                                <div class="box-bg">
                                    <span class="bg-right"><img src="{{ URL::asset('build/img/bg/email-bg-01.png') }}"
                                            alt="Img"></span>
                                    <span class="bg-left"><img src="{{ URL::asset('build/img/bg/email-bg-02.png') }}"
                                            alt="Img"></span>
                                </div>
                            </div>
                            <!-- /Upgrade Details -->
