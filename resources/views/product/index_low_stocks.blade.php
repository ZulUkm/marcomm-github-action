        ...
        <div class="content">
            <div class="page-header">
                ...
                <ul class="table-top-head low-stock-top-head">
                    ...
                    <li>
                        <a href="#" class="btn btn-secondary w-auto shadow-none" data-bs-toggle="modal"
                            data-bs-target="#send-email"><i data-feather="mail" class="feather-mail"></i>Send Email</a>
                    </li>
                </ul>
            </div>
            <div class="mb-4">
                                ...
                                <div
                                    ...
                                    <div class="dropdown me-2">
                                        ...
                                        <ul class="dropdown-menu  dropdown-menu-end p-3">
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item rounded-1">Lenovo IdeaPad
                                                    3</a>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item rounded-1">Nike
                                                    Jordan</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item rounded-1">Apple Series 5
                                                    Watch</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="dropdown me-2">
                                        ...
                                        <ul class="dropdown-menu  dropdown-menu-end p-3">
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item rounded-1">James
                                                    Kirwin</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item rounded-1">Francis
                                                    Chang</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item rounded-1">Antonio
                                                    Engle</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item rounded-1">Leo
                                                    Kelly</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu  dropdown-menu-end p-3">
                                            <li>
                                                <a href="javascript:void(0);"
                                                    class="dropdown-item rounded-1">Computers</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);"
                                                    class="dropdown-item rounded-1">Electronics</a>
                                            </li>
                                            <li>
                            ...
                            <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3">
                                ...
                                <div
                                    ...
                                    <div class="dropdown me-2">
                                        ...
                                        <ul class="dropdown-menu  dropdown-menu-end p-3">
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item rounded-1">Lenovo
                                                    IdeaPad 3</a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item rounded-1">Beats Pro
                                                </a>
                                            </li>
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item rounded-1">Nike
                                            ...
                                            <li>
                                                <a href="javascript:void(0);" class="dropdown-item rounded-1">Apple Series
                                                    5 Watch</a>
                                            </li>
                                        </ul>
                                    </div>
