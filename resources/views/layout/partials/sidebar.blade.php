@if (!Route::is(['pos', 'pos-2', 'pos-3', 'pos-4', 'pos-5', 'pos.index', 'pos.order', 'orders.create']))
    <!-- Sidebar -->
            ...
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="submenu-open">
                        <h6 class="submenu-hdr">Marcomm</h6>
                        <ul>

                            {{-- Dashboard  --}}
                            <li class="submenu">
                                <a href="{{ route('admin.dashboard') }}"
                                    class="{{ Request::is('admin.dashboard') ? 'active subdrop' : '' }}"><i
                                        class="ti ti-layout-dashboard fs-16 me-2"></i><span>Dashboard</span></a>
                            </li>

                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('orders.*') ? 'active subdrop' : '' }}"><i
                                        class="ti ti-shopping-bag fs-16 me-2"></i><span>Orders</span><span
                                        class="menu-arrow"></span></a>
                                <ul>
                                    <li><a href="{{ route('orders.create') }}"
                                            class="{{ Request::is('orders.create') ? 'active' : '' }}">Add Order</a>
                                    </li>
                                    <li><a href="{{ route('orders.index') }}"
                                            class="{{ Request::is('orders.index') ? 'active' : '' }}">List Orders</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            @role('admin')
                                <li class="submenu">
                                    <a href="javascript:void(0);"
                                        class="{{ Request::is('admin/orders.*') ? 'active subdrop' : '' }}"><i
                                            class="ti ti-shopping-bag fs-16 me-2"></i><span>Admin Order</span><span
                                            class="menu-arrow"></span></a>
                                    <ul>
                                        <li><a href="{{ route('admin.orders.index') }}"
                                                class="{{ Request::is('admin/orders.index') ? 'active' : '' }}">List
                                                Admin Orders</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="submenu">
                                    <a href="javascript:void(0);"
                                        class="{{ Request::is('products*') ? 'active subdrop' : '' }}"><i
                                            class="ti ti-package fs-16 me-2"></i><span>Products</span><span
                                            class="menu-arrow"></span></a>
                                    <ul>
                                        <li><a href="{{ route('products.create') }}"
                                                class="{{ Request::is('products/create') ? 'active' : '' }}">Add
                                                Product</a>
                                        </li>
                                        <li><a href="{{ route('products.index') }}"
                                                class="{{ Request::is('products') ? 'active' : '' }}">List
                                                Products</a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="submenu">
                                    <a href="javascript:void(0);"
                                        class="{{ Request::is('users*') ? 'active subdrop' : '' }}"><i
                                            class="ti ti-users fs-16 me-2"></i><span>Users</span><span
                                            class="menu-arrow"></span></a>
                                    <ul>
                                        <li><a href="{{ route('users.create') }}"
                                                class="{{ Request::is('users/create') ? 'active' : '' }}">Add
                                                User</a>
                                        </li>
                                        <li><a href="{{ route('users.index') }}"
                                                class="{{ Request::is('users') ? 'active' : '' }}">List
                                                Users</a>
                                        </li>
                                    </ul>
                                </li>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('categories*') ? 'active subdrop' : '' }}"><i
                                        class="ti ti-package fs-16 me-2"></i><span>Categories</span><span
                                        class="menu-arrow"></span></a>
                                <ul>
                                    <li><a href="{{ route('product-category.create') }}"
                                            class="{{ Request::is('products/create') ? 'active' : '' }}">Add
                                            Category</a>
                                    </li>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('calendar*') ? 'active subdrop' : '' }}"><i
                                        class="ti ti-calendar fs-16 me-2"></i><span>Calendar</span><span
                                        class="menu-arrow"></span></a>
                                <ul>
                                    <li><a href="{{ route('calendar.index') }}"
                                            class="{{ Request::is('calendar') ? 'active' : '' }}">View Calendar</a>
                                    </li>
                                </ul>
                            </li>
                    ...
                    {{-- <li class="submenu-open">
                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('dashboard', 'companies', 'subscription', 'packages', 'domain', 'purchase-transaction') ? 'active subdrop' : '' }}"><i
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ url('domain') }}"
                                            class="{{ Request::is('domain') ? 'active' : '' }}">Domain</a>
                                    </li>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li class="submenu submenu-two"><a href="javascript:void(0);"
                                            class="{{ Request::is('products', 'orders', 'customers', 'cart', 'checkout', 'wishlist', 'reviews') ? 'active' : '' }}">Ecommerce<span
                                                class="menu-arrow inside-submenu"></span></a>
                                        <ul>
                                            ...
                                            <li><a href="{{ url('orders') }}"
                                                    class="{{ Request::is('orders') ? 'active' : '' }}">Orders</a>
                                            </li>
                                            <li><a href="{{ url('customers') }}"
                                                    class="{{ Request::is('customers') ? 'active' : '' }}">Customers</a>
                                            </li>
                                            <li><a href="{{ url('cart') }}"
                                                    class="{{ Request::is('cart') ? 'active' : '' }}">Cart</a>
                                            </li>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('layout-horizontal', 'layout-detached', 'layout-modern', 'layout-two-column', 'layout-hovered', 'layout-boxed', 'layout-rtl', 'layout-dark') ? 'active' : '' }}"><i
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ url('layout-modern') }}"
                                            class="{{ Request::is('layout-modern') ? 'active' : '' }}">Modern</a>
                                    </li>
                                    <li><a href="{{ url('layout-two-column') }}"
                                            class="{{ Request::is('layout-two-column') ? 'active' : '' }}">Two
                                            Column</a></li>
                                    <li><a href="{{ url('layout-hovered') }}"
                                            class="{{ Request::is('layout-hovered') ? 'active' : '' }}">Hovered</a>
                                    </li>
                                    <li><a href="{{ url('layout-boxed') }}"
                                            class="{{ Request::is('layout-boxed') ? 'active' : '' }}">Boxed</a>
                                    </li>
                                    <li><a href="{{ url('layout-rtl') }}"
                                            class="{{ Request::is('layout-rtl') ? 'active' : '' }}">RTL</a>
                                    </li>
                                    <li><a href="{{ url('layout-dark') }}"
                                            class="{{ Request::is('layout-dark') ? 'active' : '' }}">Dark</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <li class="submenu-open">
                        ...
                        <ul>
                            ...
                            <li class="{{ Request::is('sub-categories') ? 'active' : '' }}"><a
                                    href="{{ url('sub-categories') }}"><i
                                        class="ti ti-carousel-vertical fs-16 me-2"></i><span>Sub
                                        Category</span></a>
                            </li>
                            <li class="{{ Request::is('brand-list') ? 'active' : '' }}"><a
                                    href="{{ url('brand-list') }}"><i
                                        class="ti ti-triangles fs-16 me-2"></i><span>Brands</span></a></li>
                            <li class="{{ Request::is('units') ? 'active' : '' }}"><a
                                    href="{{ url('units') }}"><i
                                        class="ti ti-brand-unity fs-16 me-2"></i><span>Units</span></a></li>
                            <li class="{{ Request::is('varriant-attributes') ? 'active' : '' }}"><a
                                    href="{{ url('varriant-attributes') }}"><i
                                        class="ti ti-checklist fs-16 me-2"></i><span>Variant
                                        Attributes</span></a></li>
                            <li class="{{ Request::is('warranty') ? 'active' : '' }}"><a
                                    href="{{ url('warranty') }}"><i
                                        class="ti ti-certificate fs-16 me-2"></i><span>Warranties</span></a>
                            </li>
                            <li class="{{ Request::is('barcode') ? 'active' : '' }}"><a
                                    href="{{ url('barcode') }}"><i class="ti ti-barcode fs-16 me-2"></i><span>Print
                                        Barcode</span></a></li>
                            <li class="{{ Request::is('qrcode') ? 'active' : '' }}"><a
                                    href="{{ url('qrcode') }}"><i class="ti ti-qrcode fs-16 me-2"></i><span>Print QR
                                        Code</span></a></li>
                        </ul>
                    </li>
                    <li class="submenu-open">
                        ...
                        <ul>
                            <li class="{{ Request::is('manage-stocks') ? 'active' : '' }}"><a
                                    href="{{ url('manage-stocks') }}"><i
                                        class="ti ti-stack-3 fs-16 me-2"></i><span>Manage Stock</span></a></li>
                            <li class="{{ Request::is('stock-adjustment') ? 'active' : '' }}"><a
                                    href="{{ url('stock-adjustment') }}"><i
                                        class="ti ti-stairs-up fs-16 me-2"></i><span>Stock
                                        Adjustment</span></a></li>
                            <li class="{{ Request::is('stock-transfer') ? 'active' : '' }}"><a
                                    href="{{ url('stock-transfer') }}"><i
                                        class="ti ti-stack-pop fs-16 me-2"></i><span>Stock Transfer</span></a>
                            </li>
                        </ul>
                    </li>
                    <li class="submenu-open">
                    ...
                    <li class="submenu-open">
                        ...
                        <ul>
                            <li class="{{ Request::is('coupons') ? 'active' : '' }}"><a
                                    href="{{ url('coupons') }}"><i
                                        class="ti ti-ticket fs-16 me-2"></i><span>Coupons</span></a></li>
                            <li class="{{ Request::is('gift-cards') ? 'active' : '' }}"><a
                                    href="{{ url('gift-cards') }}"><i class="ti ti-cards fs-16 me-2"></i><span>Gift
                                        Cards</span></a></li>
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('discount-plan', 'discount') ? 'active' : '' }}"><i
                                        class="ti ti-file-percent fs-16 me-2"></i><span>Discount</span><span
                                        class="menu-arrow"></span></a>
                                <ul>
                                    <li><a href="{{ url('discount-plan') }}"
                                            class="{{ Request::is('discount-plan') ? 'active' : '' }}">Discount
                                            Plan</a></li>
                                    <li><a href="{{ url('discount') }}"
                        ...
                        <ul>
                            <li class="{{ Request::is('purchase-list') ? 'active' : '' }}"><a
                                    href="{{ url('purchase-list') }}"><i
                                        class="ti ti-shopping-bag fs-16 me-2"></i><span>Purchases</span></a>
                            </li>
                            <li class="{{ Request::is('purchase-order-report') ? 'active' : '' }}"><a
                                    href="{{ url('purchase-order-report') }}"><i
                                        class="ti ti-file-unknown fs-16 me-2"></i><span>Purchase
                                        Order</span></a></li>
                            <li class="{{ Request::is('purchase-returns') ? 'active' : '' }}"><a
                                    href="{{ url('purchase-returns') }}"><i
                                        class="ti ti-file-upload fs-16 me-2"></i><span>Purchase
                                        Return</span></a></li>
                        </ul>
                    </li>
                    <li class="submenu-open">
                        ...
                        <ul>
                            <li class="submenu">
                                ...
                                <ul>
                                    <li><a href="{{ url('expense-list') }}"
                                            class="{{ Request::is('expense-list') ? 'active' : '' }}">Expenses</a>
                                    </li>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('income', 'income-category') ? 'active' : '' }}"><i
                                        class="ti ti-file-pencil fs-16 me-2"></i><span>Income</span><span
                                        class="menu-arrow"></span></a>
                                <ul>
                                    <li><a href="{{ url('income') }}"
                                            class="{{ Request::is('income') ? 'active' : '' }}">Income</a>
                                    </li>
                                    <li><a href="{{ url('income-category') }}"
                                            class="{{ Request::is('income-category') ? 'active' : '' }}">Income
                                            Category</a></li>
                                </ul>
                            </li>
                            <li class="{{ Request::is('account-list') ? 'active' : '' }}"><a
                                    href="{{ url('account-list') }}"><i
                                        class="ti ti-building-bank fs-16 me-2"></i><span>Bank
                                        Accounts</span></a></li>
                            <li class="{{ Request::is('money-transfer') ? 'active' : '' }}"><a
                                    href="{{ url('money-transfer') }}"><i
                                        class="ti ti-moneybag fs-16 me-2"></i><span>Money Transfer</span></a>
                            </li>
                            <li class="{{ Request::is('balance-sheet', 'balance-sheet-v2') ? 'active' : '' }}">
                                <a href="{{ url('balance-sheet') }}"><i
                                        class="ti ti-report-money fs-16 me-2"></i><span>Balance
                                        Sheet</span></a>
                            </li>
                            <li class="{{ Request::is('trial-balance') ? 'active' : '' }}"><a
                                    href="{{ url('trial-balance') }}"><i
                                        class="ti ti-alert-circle fs-16 me-2"></i><span>Trial
                                        Balance</span></a></li>
                            <li class="{{ Request::is('cash-flow') ? 'active' : '' }}"><a
                                    href="{{ url('cash-flow') }}"><i
                                        class="ti ti-zoom-money fs-16 me-2"></i><span>Cash Flow</span></a></li>
                            <li class="{{ Request::is('account-statement') ? 'active' : '' }}"><a
                                    href="{{ url('account-statement') }}"><i
                    ...
                    <li class="submenu-open">
                        ...
                        <ul>
                            <li
                                class="{{ Request::is('employees-grid', 'employees-list', 'add-employee', 'edit-employee', 'employee-details') ? 'active' : '' }}">
                                <a href="{{ url('employees-grid') }}"><i
                                        class="ti ti-user fs-16 me-2"></i><span>Employees</span></a>
                            </li>
                            <li class="{{ Request::is('department-grid') ? 'active' : '' }}"><a
                            ...
                            <li class="{{ Request::is('designation') ? 'active' : '' }}"><a
                                    href="{{ url('designation') }}"><i
                                        class="ti ti-git-merge fs-16 me-2"></i><span>Designation</span></a>
                            </li>
                            <li class="{{ Request::is('shift') ? 'active' : '' }}"><a
                                    href="{{ url('shift') }}"><i
                                        class="ti ti-arrows-shuffle fs-16 me-2"></i><span>Shifts</span></a>
                            </li>
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('attendance-employee', 'attendance-admin') ? 'active' : '' }}"><i
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ url('attendance-admin') }}"
                                            class="{{ Request::is('attendance-admin') ? 'active' : '' }}">Admin</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('leaves-admin', 'leaves-employee', 'leave-types') ? 'active' : '' }}"><i
                                        class="ti ti-calendar fs-16 me-2"></i><span>Leaves</span><span
                                        class="menu-arrow"></span></a>
                                <ul>
                                    <li><a href="{{ url('leaves-admin') }}"
                                            class="{{ Request::is('leaves-admin') ? 'active' : '' }}">Admin
                                            Leaves</a></li>
                                    <li><a href="{{ url('leaves-employee') }}"
                                            class="{{ Request::is('leaves-employee') ? 'active' : '' }}">Employee
                                            Leaves</a></li>
                                    <li><a href="{{ url('leave-types') }}"
                                            class="{{ Request::is('leave-types') ? 'active' : '' }}">Leave
                                            Types</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="submenu">
                                <a href="{{ url('employee-salary') }}"
                                    class="{{ Request::is('employee-salary', 'payslip') ? 'active' : '' }}"><i
                    ...
                    <li class="submenu-open">
                        ...
                        <ul>
                            <li class="submenu">
                                ...
                                <ul>
                                    <li><a href="{{ url('sales-report') }}"
                                            class="{{ Request::is('sales-report') ? 'active' : '' }}">Sales
                                            Report</a></li>
                            ...
                            <li class="{{ Request::is('purchase-report') ? 'active' : '' }}"><a
                                    href="{{ url('purchase-report') }}"><i
                                        class="ti ti-chart-pie-2 fs-16 me-2"></i><span>Purchase
                                        report</span></a></li>
                            <li class="submenu">
                                <a href="javascript:void(0);"
                            ...
                            <li class="{{ Request::is('invoice-report') ? 'active' : '' }}"><a
                                    href="{{ url('invoice-report') }}"><i
                                        class="ti ti-businessplan fs-16 me-2"></i><span>Invoice
                                        Report</span></a></li>
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('supplier-report', 'supplier-due-report') ? 'active' : '' }}"><i
                                        class="ti ti-user-star fs-16 me-2"></i><span>Supplier
                                        Report</span><span class="menu-arrow"></span></a>
                                <ul>
                                    <li><a href="{{ url('supplier-report') }}"
                                            class="{{ Request::is('supplier-report') ? 'active' : '' }}">Supplier
                                            Report</a></li>
                                    <li><a href="{{ url('supplier-due-report') }}"
                            ...
                            <li class="submenu">
                                <a
                                    href="javascript:void(0);"class="{{ Request::is('customer-report', 'customer-due-report') ? 'active' : '' }}"><i
                                ...
                                <ul>
                                    <li><a href="{{ url('customer-report') }}"
                                            ...
                                            Report</a></li>
                                    <li><a href="{{ url('customer-due-report') }}"
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('product-report', 'product-expiry-report', 'product-quantity-alert') ? 'active' : '' }}"><i
                                        class="ti ti-report-analytics fs-16 me-2"></i><span>Product
                                        Report</span><span class="menu-arrow"></span></a>
                                <ul>
                                    <li><a href="{{ url('product-report') }}"
                                            class="{{ Request::is('product-report') ? 'active' : '' }}">Product
                                            Report</a></li>
                                    <li><a href="{{ url('product-expiry-report') }}"
                                            class="{{ Request::is('product-expiry-report') ? 'active' : '' }}">Product
                                            Expiry Report</a></li>
                                    <li><a href="{{ url('product-quantity-alert') }}"
                                            class="{{ Request::is('product-quantity-alert') ? 'active' : '' }}">Product
                                            Quantity Alert</a></li>
                                </ul>
                            </li>
                            <li class="{{ Request::is('expense-report') ? 'active' : '' }}"><a
                                    href="{{ url('expense-report') }}"><i
                                        class="ti ti-file-vector fs-16 me-2"></i><span>Expense
                                        Report</span></a></li>
                            <li class="{{ Request::is('income-report') ? 'active' : '' }}"><a
                                    href="{{ url('income-report') }}"><i
                                        class="ti ti-chart-ppf fs-16 me-2"></i><span>Income Report</span></a>
                            </li>
                            <li class="{{ Request::is('tax-reports') ? 'active' : '' }}"><a
                                    href="{{ url('tax-reports') }}"><i
                                        class="ti ti-chart-dots-2 fs-16 me-2"></i><span>Tax Report</span></a>
                            </li>
                            <li class="{{ Request::is('profit-and-loss') ? 'active' : '' }}"><a
                                    href="{{ url('profit-and-loss') }}"><i
                                        class="ti ti-chart-donut fs-16 me-2"></i><span>Profit & Loss</span></a>
                            </li>
                            <li class="{{ Request::is('annual-report') ? 'active' : '' }}"><a
                                    href="{{ url('annual-report') }}"><i
                                        class="ti ti-report-search fs-16 me-2"></i><span>Annual
                                        Report</span></a></li>
                        </ul>
                    </li>
                    <li class="submenu-open">
                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('all-blog', 'blog-details', 'blog-tag', 'blog-categories', 'blog-comments') ? 'active' : '' }}"><i
                                        class="ti ti-wallpaper fs-16 me-2"></i><span>Blog</span><span
                                        class="menu-arrow"></span></a>
                                <ul>
                                    <li><a href="{{ url('all-blog') }}"
                                            class="{{ Request::is('all-blog', 'blog-details') ? 'active' : '' }}">All
                                            Blog</a></li>
                                    <li><a href="{{ url('blog-tag') }}"
                                            class="{{ Request::is('blog-tag') ? 'active' : '' }}">Blog
                                            Tags</a></li>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('countries', 'states', 'cities') ? 'active' : '' }}"><i
                    ...
                    <li class="submenu-open">
                        ...
                        <ul>
                            ...
                            <li class="{{ Request::is('roles-permissions') ? 'active' : '' }}"><a
                                    href="{{ url('roles-permissions') }}"><i
                                        class="ti ti-jump-rope fs-16 me-2"></i><span>Roles &
                                        Permissions</span></a>
                            </li>
                            <li class="{{ Request::is('delete-account') ? 'active' : '' }}"><a
                                    href="{{ url('delete-account') }}"><i
                                        class="ti ti-trash-x fs-16 me-2"></i><span>Delete Account
                                        Request</span></a>
                            </li>
                        </ul>
                    </li>
                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    <li class="submenu submenu-two"><a href="javascript:void(0);">Login<span
                                        ...
                                        <ul>
                                            <li><a href="{{ url('signin') }}"
                                                    class="{{ Request::is('signin') ? 'active' : '' }}">Cover</a>
                                            </li>
                                            <li><a href="{{ url('signin-2') }}"
                                                    class="{{ Request::is('signin-2') ? 'active' : '' }}">Illustration</a>
                                            </li>
                                            <li><a href="{{ url('signin-3') }}"
                                                    class="{{ Request::is('signin-3') ? 'active' : '' }}">Basic</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="{{ Request::is('lock-screen') ? 'active' : '' }}"><a
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    <li><a href="{{ url('error-404') }}"
                                            class="{{ Request::is('error-404') ? 'active' : '' }}">404 Error
                                        </a>
                                    </li>
                                    <li><a href="{{ url('error-500') }}"
                                            class="{{ Request::is('error-500') ? 'active' : '' }}">500 Error
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="{{ Request::is('blank-page') ? 'active' : '' }}">
                                <a href="{{ url('blank-page') }}"><i class="ti ti-file fs-16 me-2"></i><span>Blank
                                        Page</span> </a>
                            </li>
                            ...
                            <li class="{{ Request::is('coming-soon') ? 'active' : '' }}">
                                <a href="{{ url('coming-soon') }}"><i class="ti ti-send fs-16 me-2"></i><span>Coming
                                        Soon</span> </a>
                            </li>
                    ...
                    <li class="submenu-open">
                        ...
                        <ul>
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('general-settings', 'security-settings', 'notification', 'activities', 'connected-apps') ? 'active' : '' }}"><i
                                        class="ti ti-settings fs-16 me-2"></i><span>General
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('system-settings', 'company-settings', 'localization-settings', 'prefixes', 'preference', 'appearance', 'social-authentication', 'language-settings') ? 'active' : '' }}"><i
                                        class="ti ti-world fs-16 me-2"></i><span>Website Settings</span><span
                                        class="menu-arrow"></span></a>
                                <ul>
                                    ...
                                    <li><a href="{{ url('preference') }}"
                                            class="{{ Request::is('preference') ? 'active' : '' }}">Preference</a>
                                    </li>
                                    ...
                                    <li><a href="{{ url('language-settings') }}"
                                            class="{{ Request::is('language-settings') ? 'active' : '' }}">Language</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('invoice-settings', 'invoice-template', 'printer-settings', 'pos-settings', 'custom-fields') ? 'active' : '' }}"><i
                                        class="ti ti-device-mobile fs-16 me-2"></i>
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ url('pos-settings') }}"
                                            class="{{ Request::is('pos-settings') ? 'active' : '' }}">POS</a>
                                    </li>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('email-settings', 'email-template', 'sms-settings', 'sms-template', 'otp-settings', 'gdpr-settings', 'payment-gateway-settings', 'bank-settings-grid', 'tax-rates', 'currency-settings') ? 'active' : '' }}"><i
                                        class="ti ti-device-desktop fs-16 me-2"></i>
                                    <span>System Settings</span><span class="menu-arrow"></span>
                                </a>
                                <ul>
                                    <li class="submenu submenu-two"><a href="javascript:void(0);"
                                            class="{{ Request::is('email-settings', 'email-template') ? 'active' : '' }}">Email<span
                                                class="menu-arrow inside-submenu"></span></a>
                                        <ul>
                                    ...
                                    <li class="submenu submenu-two"><a href="javascript:void(0);"
                                            class="{{ Request::is('sms-settings', 'sms-template') ? 'active' : '' }}">SMS<span
                                                class="menu-arrow inside-submenu"></span></a>
                                        <ul>
                                    ...
                                    <li class="{{ Request::is('otp-settings') ? 'active' : '' }}"><a
                                            href="{{ url('otp-settings') }}">OTP</a></li>
                                    <li class="{{ Request::is('gdpr-settings') ? 'active' : '' }}"><a
                                            href="{{ url('gdpr-settings') }}">GDPR Cookies</a></li>
                                </ul>
                            </li>
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('payment-gateway-settings', 'bank-settings-grid', 'tax-rates', 'currency-settings') ? 'active' : '' }}"><i
                                        class="ti ti-settings-dollar fs-16 me-2"></i>
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ url('bank-settings-grid') }}"
                                            class="{{ Request::is('bank-settings-grid') ? 'active' : '' }}">Bank
                                            Accounts</a></li>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('storage-settings', 'ban-ip-address') ? 'active' : '' }}"><i
                                        class="ti ti-settings-2 fs-16 me-2"></i>
                        ...
                        <ul>
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ url('ui-sortable') }}"
                                            class="{{ Request::is('ui-sortable') ? 'active' : '' }}">Sortable</a>
                                    </li>
                                    <li><a href="{{ url('ui-swiperjs') }}"
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('chart-apex', 'chart-c3', 'chart-js', 'chart-morris', 'chart-flot', 'chart-peity') ? 'active subdrop' : '' }}"><i
                                        class="ti ti-chart-infographic fs-16 me-2"></i>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('icon-fontawesome', 'icon-tabler', 'icon-bootstrap', 'icon-remix', 'icon-feather', 'icon-ionic', 'icon-material', 'icon-pe7', 'icon-simpleline', 'icon-themify', 'icon-weather', 'icon-typicon', 'icon-flag') ? 'active subdrop' : '' }}"><i
                                        class="ti ti-icons fs-16 me-2"></i>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('tables-basic', 'data-tables') ? 'active' : '' }}"><i
                    ...
                    <li class="submenu-open">
                        ...
                        <ul>
                            <li><a href="javascript:void(0);"><i
                                        class="ti ti-file-text fs-16 me-2"></i><span>Documentation</span></a>
                            </li>
                            <li><a href="javascript:void(0);"><i class="ti ti-exchange fs-16 me-2"></i><span>Changelog
                                    </span><span
                                        class="badge bg-primary badge-xs text-white fs-10 ms-2">v2.1.3</span></a>
                            </li>
                            <li class="submenu">
                ...
                <ul>
                        ...
                        <ul>
                            ...
                            <li class="{{ Request::is('barcode') ? 'active' : '' }}"><a
                                    href="{{ url('barcode') }}"><i class="ti ti-barcode fs-16 me-2"></i><span>Print
                                        Barcode</span></a></li>
                            <li class="{{ Request::is('qrcode') ? 'active' : '' }}"><a
                                    href="{{ url('qrcode') }}"><i class="ti ti-qrcode fs-16 me-2"></i><span>Print
                                        QR Code</span></a></li>
                        </ul>
                    </li>
                    <li class="submenu-open">
                    ...
                    <li class="submenu-open">
                        ...
                        <ul>
                            <li class="submenu">
                                ...
                                <ul>
                                    <li><a href="{{ url('online-orders') }}"
                                            ...
                                            Orders</a></li>
                                    <li><a href="{{ url('pos-orders') }}"
                                            class="{{ Request::is('pos-orders') ? 'active' : '' }}">POS Orders</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="{{ Request::is('invoice') ? 'active' : '' }}"><a
                            ...
                            <li class="{{ Request::is('sales-returns') ? 'active' : '' }}"><a
                                    href="{{ url('sales-returns') }}"><i
                                        class="ti ti-receipt-refund fs-16 me-2"></i><span>Sales Return</span></a></li>
                            <li class="{{ Request::is('quotation-list') ? 'active' : '' }}"><a
                                    href="{{ url('quotation-list') }}"><i
                                        class="ti ti-files fs-16 me-2"></i><span>Quotation</span></a></li>
                            <li class="submenu">
                    ...
                    <li class="submenu-open">
                        ...
                        <ul>
                            ...
                            <li class="{{ Request::is('account-list') ? 'active' : '' }}"><a
                                    href="{{ url('account-list') }}"><i
                                        class="ti ti-building-bank fs-16 me-2"></i><span>Bank Accounts</span></a></li>
                            <li class="{{ Request::is('money-transfer') ? 'active' : '' }}"><a
                                    href="{{ url('money-transfer') }}"><i
                                        class="ti ti-moneybag fs-16 me-2"></i><span>Money Transfer</span></a></li>
                            <li class="{{ Request::is('balance-sheet') ? 'active' : '' }}"><a
                                    href="{{ url('balance-sheet') }}"><i
                                        class="ti ti-report-money fs-16 me-2"></i><span>Balance Sheet</span></a></li>
                            <li class="{{ Request::is('trial-balance') ? 'active' : '' }}"><a
                                    href="{{ url('trial-balance') }}"><i
                                        class="ti ti-alert-circle fs-16 me-2"></i><span>Trial Balance</span></a></li>
                            <li class="{{ Request::is('cash-flow') ? 'active' : '' }}"><a
                                    href="{{ url('cash-flow') }}"><i
                                        class="ti ti-zoom-money fs-16 me-2"></i><span>Cash Flow</span></a></li>
                            <li class="{{ Request::is('account-statement') ? 'active' : '' }}"><a
                                    href="{{ url('account-statement') }}"><i
                                        class="ti ti-file-infinity fs-16 me-2"></i><span>Account Statement</span></a>
                            </li>
                    ...
                    <li class="submenu-open">
                        <h6 class="submenu-hdr">HRM</h6>
                        <ul>
                            <li class="{{ Request::is('employees-grid') ? 'active' : '' }}"><a
                    ...
                    <li class="submenu-open">
                        ...
                        <ul>
                            ...
                            <li class="{{ Request::is('purchase-report') ? 'active' : '' }}"><a
                                    href="{{ url('purchase-report') }}"><i
                                        class="ti ti-chart-pie-2 fs-16 me-2"></i><span>Purchase report</span></a></li>
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('inventory-report', 'stock-history', 'sold-stock') ? 'active' : '' }}"><i
                                        class="ti ti-triangle-inverted fs-16 me-2"></i><span>Inventory
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ url('stock-history') }}"
                                            ...
                                            History</a></li>
                                    <li><a href="{{ url('sold-stock') }}"
                                            class="{{ Request::is('sold-stock') ? 'active' : '' }}">Sold Stock</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="{{ Request::is('invoice-report') ? 'active' : '' }}"><a
                                    href="{{ url('invoice-report') }}"><i
                                        class="ti ti-businessplan fs-16 me-2"></i><span>Invoice Report</span></a></li>
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('supplier-report', 'supplier-due-report') ? 'active' : '' }}"><i
                            ...
                            <li class="{{ Request::is('expense-report') ? 'active' : '' }}"><a
                                    href="{{ url('expense-report') }}"><i
                                        class="ti ti-file-vector fs-16 me-2"></i><span>Expense Report</span></a></li>
                            <li class="{{ Request::is('income-report') ? 'active' : '' }}"><a
                                    href="{{ url('income-report') }}"><i
                                        class="ti ti-chart-ppf fs-16 me-2"></i><span>Income Report</span></a></li>
                            <li class="{{ Request::is('tax-reports') ? 'active' : '' }}"><a
                                    href="{{ url('tax-reports') }}"><i
                                        class="ti ti-chart-dots-2 fs-16 me-2"></i><span>Tax Report</span></a></li>
                            <li class="{{ Request::is('profit-and-loss') ? 'active' : '' }}"><a
                                    href="{{ url('profit-and-loss') }}"><i
                                        class="ti ti-chart-donut fs-16 me-2"></i><span>Profit & Loss</span></a></li>
                            <li class="{{ Request::is('annual-report') ? 'active' : '' }}"><a
                                    href="{{ url('annual-report') }}"><i
                                        class="ti ti-report-search fs-16 me-2"></i><span>Annual Report</span></a></li>
                        </ul>
                    </li>
                    <li class="submenu-open">
                        <h6 class="submenu-hdr">Content (CMS)</h6>
                        <ul>
                            ...
                            <li class="submenu">
                                <a href="javascript:void(0);"
                                    class="{{ Request::is('all-blog', 'blog-tag', 'blog-categories', 'blog-comments') ? 'active' : '' }}"><i
                                        class="ti ti-wallpaper fs-16 me-2"></i><span>Blog</span><span
                                        class="menu-arrow"></span></a>
                                <ul>
                                    <li><a href="{{ url('all-blog') }}"
                                            class="{{ Request::is('all-blog') ? 'active' : '' }}">All Blog</a></li>
                                    <li><a href="{{ url('blog-tag') }}"
                    ...
                    <li class="submenu-open">
                        ...
                        <ul>
                            ...
                            <li class="{{ Request::is('delete-account') ? 'active' : '' }}"><a
                                    href="{{ url('delete-account') }}"><i
                                        class="ti ti-trash-x fs-16 me-2"></i><span>Delete Account Request</span></a>
                            </li>
                        </ul>
                    </li>
                    <li class="submenu-open">
                        ...
                        <ul>
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    <li><a href="{{ url('error-404') }}"
                                            class="{{ Request::is('error-404') ? 'active' : '' }}">404 Error </a>
                                    </li>
                                    <li><a href="{{ url('error-500') }}"
                                            class="{{ Request::is('error-500') ? 'active' : '' }}">500 Error </a>
                                    </li>
                                </ul>
                            </li>
                            <li class="{{ Request::is('blank-page') ? 'active' : '' }}">
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ url('bank-settings-grid') }}"
                                            ...
                                            Accounts</a></li>
                                    <li><a href="{{ url('tax-rates') }}"
                                            class="{{ Request::is('tax-rates') ? 'active' : '' }}">Tax Rates</a>
                                    </li>
                                    <li><a href="{{ url('currency-settings') }}"
                                            class="{{ Request::is('currency-settings') ? 'active' : '' }}">Currencies</a>
                                    </li>
                    ...
                    <li class="submenu-open">
                        ...
                        <ul>
                            ...
                            <li><a href="javascript:void(0);"><i
                                        ...
                                        class="badge bg-primary badge-xs text-white fs-10 ms-2">v2.1.3</span></a></li>
                            <li class="submenu">
                                <a href="javascript:void(0);"><i class="ti ti-menu-2 fs-16 me-2"></i><span>Multi
                                        Level</span><span class="menu-arrow"></span></a>
                                <ul>
