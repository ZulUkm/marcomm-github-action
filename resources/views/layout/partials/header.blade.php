             ...
             <ul class="nav user-menu">
                 ...
                 <li class="nav-item dropdown has-arrow flag-nav nav-item-box">
                     <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="javascript:void(0);"
                         role="button">
                         <img src="{{ URL::asset('build/img/flags/us-flag.svg') }}" alt="Language"
                             class="img-fluid">
                     </a>
                     <div class="dropdown-menu dropdown-menu-right">
                         <a href="javascript:void(0);" class="dropdown-item">
                             <img src="{{ URL::asset('build/img/flags/english.svg') }}" alt="Img"
                                 height="16">English
                         </a>
                         <a href="javascript:void(0);" class="dropdown-item">
                             <img src="{{ URL::asset('build/img/flags/arabic.svg') }}" alt="Img"
                                 height="16">Arabic
                         </a>
                     </div>
                 </li>
                                 ...
                                 <li class="notification-message">
                                     <a href="{{ url('activities') }}" class="recent-msg">
                                         <div class="media d-flex">
                                             ...
                                             <div class="flex-grow-1">
                                                 <p class="noti-details">Payment of $50 received for Order #67890 from
                 ...
                 <li class="nav-item dropdown has-arrow main-drop profile-nav">
                     ...
                     <div class="dropdown-menu menu-drop-user">
                         <div class="profileset d-flex align-items-center">
                             ...
                             <div>
                                 <h6 class="fw-medium">{{ Auth::check() ? Auth::user()->name : '' }}</h6>
                                 <p>Admin</p>
                             </div>
                         </div>
 ...
 @if (Route::is(['pos', 'pos-2', 'pos-3', 'pos-4', 'pos-5', 'pos.index']))
     <!-- Header -->
