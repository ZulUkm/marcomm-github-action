...
<div class="sidebar-themesettings offcanvas offcanvas-end" id="theme-setting">
    <div class="offcanvas-header d-flex align-items-center justify-content-between bg-dark">
        ...
        <a href="#" class="custom-btn-close d-flex align-items-center justify-content-center text-white" data-bs-dismiss="offcanvas"><i
                class="ti ti-x"></i></a>
    </div>
        ...
        <div class="accordion accordion-customicon1 accordions-items-seperate" id="settingtheme">
            <div class="accordion-item border px-3 layout-select">
                <h2 class="accordion-header">
                    <button class="accordion-button text-dark bg-transparent fs-16 px-0 py-3" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="row gx-3">
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="miniLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="{{ asset('build/img/theme/mini.svg') }}" alt="img">
                                        </span>
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="twocolumnLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="{{ asset('build/img/theme/two-column.svg') }}" alt="img">
                                        </span>
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="horizontalLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="{{ asset('build/img/theme/horizontal.svg') }}" alt="img">
                                        </span>
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="detachedLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="{{ asset('build/img/theme/detached.svg') }}" alt="img">
                                        </span>
                            ...
                            <div class="col-4">
                                <div class="theme-layout mb-3">
                                    ...
                                    <label for="without-headerLayout">
                                        <span class="d-block mb-2 layout-img">
                                            <img src="{{ asset('build/img/theme/without-header.svg') }}" alt="img">
                                        </span>
                            ...
                            <div class="col-4">
                                <a href="{{ url('layout-rtl') }}" class="theme-layout mb-3">
                                    <span class="d-block mb-2 layout-img">
                                        <img src="{{ asset('build/img/theme/rtl.svg') }}" alt="img">
                                    </span>
            ...
            <div class="accordion-item border px-3 layout-select">
                <h2 class="accordion-header">
                    <button class="accordion-button text-dark fs-16 bg-transparent px-0 py-3" type="button" data-bs-toggle="collapse"
            ...
            <div class="accordion-item border px-3">
                <h2 class="accordion-header">
                    <button class="accordion-button text-dark fs-16 px-0 py-3 bg-transparent" type="button" data-bs-toggle="collapse"
                        data-bs-target="#topbarsetting" aria-expanded="true">
                        Top Bar Color
                    </button>
                </h2>
    ...
    <div class="p-3 pt-0">
        <div class="row gx-3">
            ...
            <div class="col-6">
                <a href="#" class="btn btn-primary w-100" data-bs-dismiss="offcanvas"><i class="ti ti-shopping-cart-plus me-1"></i>Buy
                    Product</a>
            </div>
        </div>
    </div>
