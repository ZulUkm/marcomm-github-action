...
<body
    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
        ...
        <div style="padding: 30px; background-color: white;">
            <div
                style="background-color: #f7fafc; border-left: 4px solid #e53e3e; padding: 20px; border-radius: 4px; margin-bottom: 30px;">
            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 30px;">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td style="text-align: center; padding: 12px; font-weight: bold; color: #e53e3e;">
            ...
            <div
                style="background-color: #fdf2f2; border-left: 4px solid #e53e3e; padding: 15px; border-radius: 4px; margin-bottom: 30px;">
                <h3 style="margin-top: 0; margin-bottom: 10px; font-size: 16px; color: #c53030;">Order Status: Rejected
                </h3>
                <p style="margin: 0; color: #c53030;">We regret to inform you that your order has been rejected.</p>
                @if ($comments)
                    <p style="margin-top: 15px; color: #c53030;"><strong>Reason for Rejection:</strong>
                        {{ $comments }}</p>
                @endif
            </div>
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="{{ route('orders.show', $order->id) }}"
                    style="background-color: #718096; color: white; padding: 12px 30px; text-decoration: none; border-radius: 4px; font-weight: 600; display: inline-block; letter-spacing: 0.5px;">
                    View Order Details
                </a>
            </div>
        </div>
